...
class SigaLivre(object):
    ...
    def criar_navegador(self):
        ...
        self.navegador = webdriver.Firefox(firefox_binary=binary, firefox_profile=fp)
    ...
    def obter_dados(self, base, dados, pasta=None):
        """Obtem dados de base salvando em pasta"""
        ...
        try:
            os.remove(os.path.join(pasta, self.arquivo))
        except OSError as erro:
